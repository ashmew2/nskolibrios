		...
		lwc_string *effective_type)
{
	...
	LOG("hlcache_migrate_ctx: type: %s", lwc_string_data(effective_type));
		...
		const llcache_event *event, void *pw)
{
	...
	case LLCACHE_EVENT_HAD_HEADERS:
	  LOG("Calling mimesniff_compute after HAD_HEADERS");
	...
	case LLCACHE_EVENT_HAD_DATA:
	  LOG("Calling mimesniff_compute after HAD_DATA");
	...
	case LLCACHE_EVENT_DONE:
	  LOG("Calling mimesniff_compute after EVENT_DONE");
	...
	case LLCACHE_EVENT_REDIRECT:
	  LOG("Calling mimesniff_compute after EVENT_REDIRECT");
