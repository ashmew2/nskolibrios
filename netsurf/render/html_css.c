			  ...
			  void *pw)
{
	...
	if (html_can_begin_conversion(parent)) {
	  /* debug_board_write_str("l141 html_css.c\n"); */
	  /* ; */
...
nserror html_css_new_stylesheets(html_content *c)
{
	...
	child.quirks = c->base.quirks;
        ...
        /* debug_board_write_str("calling hlcache_handle_retrieve Line 540"); */
	/* debug_board_write_str(nsurl_access(html_default_stylesheet_url)); */
	/* ; */
